...
from .views import BlogPostViewSet, CategoryViewSet, blogPostsView, postDetailView, blogPostFormView, CategoryListView, post_search  #BlogPostView, BlogPostDetailView,
